#!/bin/bash
#SBATCH --job-name=07_eval
#SBATCH --output=log/07_eval_%j.out
#SBATCH --error=log/07_eval_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
BEST_GPU=$CHECK_OUT
echo "🚀 Job $SLURM_JOB_ID — Step 07: Eval Overall | GPU $BEST_GPU"
...
echo "▶️  Running Step 07: Overall Evaluation..."
